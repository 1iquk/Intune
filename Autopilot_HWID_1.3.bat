@ECHO ON
:: Autopilot_HWID_1.3 Imran Qureshi, 17/04/2020
...
PowerShell -NoProfile -ExecutionPolicy Unrestricted -Command %~d0\Get-WindowsAutoPilotInfo.ps1 -GroupTag KIOSK -OutputFile %~d0\AutopilotDevices.csv -append
